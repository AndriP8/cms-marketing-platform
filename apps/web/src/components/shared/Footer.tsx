...
export function Footer({ siteConfig }: { siteConfig: SiteConfig }) {
  const { siteName, footer, nav } = siteConfig;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-zinc-500 dark:text-zinc-400 text-sm max-w-sm">
              {siteConfig.defaultSeo?.description ||
                "Building the future of digital experiences with cutting-edge tools and frameworks."}
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-zinc-200 dark:border-zinc-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-zinc-500 dark:text-zinc-400">
            {footer ||
              `© ${new Date().getFullYear()} ${siteName || "Forge"}. All rights reserved.`}
          </p>
